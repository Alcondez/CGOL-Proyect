var auto = false;
		...
		function printStatus()
		{
			...
			var livecells = document.getElementById("livecells");
			generation.innerHTML = gen;
			livecells.innerHTML = nlivecells;
		...
		{
			//delete all rows
			var arena = document.getElementById("board");
		...
		function numberOfLiveCells()
		{
			var n = 0;
			for(var x = 0; x < width; x++){
				for(var y = 0; y < height; y++){
					if(isCellAlive(x, y)) n++;
				}
			}
			return n;
		}